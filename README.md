...
```javascript
import minard from 'https://cdn.jsdelivr.net/gh/stdlib-js/datasets-minard-napoleons-march@v0.2.3-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/datasets-minard-napoleons-march/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/datasets-minard-napoleons-march/actions/workflows/test.yml?query=branch:v0.2.3
